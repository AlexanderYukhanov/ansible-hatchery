...
DOCUMENTATION = '''
---
module: azure_rm_appgwnetworkinterface
version_added: "2.5"
    ...
    dns_settings:
        ...
        suboptions:
            ...
            internal_domain_name_suffix:
                description:
                    - "Even if I(internal_dns_name_label) is not specified, a DNS entry is created for the primary NIC of the VM. This DNS name can be constr
                      ucted by concatenating the VM name with the value of internalDomainNameSuffix."
    mac_address:
        description:
...
EXAMPLES = '''
  - name: Create (or update) Network Interface
    azure_rm_appgwnetworkinterface:
      resource_group: rg1
