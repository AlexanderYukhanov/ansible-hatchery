...
class AzureRMLoadBalancerFrontendIPConfigurationsFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            ...
            self.log("LoadBalancerFrontendIPConfigurations instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the LoadBalancerFrontendIPConfigurations instance.')
        if found is True:
