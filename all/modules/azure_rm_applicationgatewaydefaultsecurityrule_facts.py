...
class AzureRMDefaultSecurityRulesFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the DefaultSecurityRules instance {0} is present".format(self.default_security_rule_name))
        found = False
        try:
            ...
            self.log("DefaultSecurityRules instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the DefaultSecurityRules instance.')
        if found is True:
