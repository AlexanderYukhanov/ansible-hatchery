...
virtual_network_rules:
    description: A list of dict results where the key is the name of the PostgreSQL Virtual Network Rule and the values are the facts for that PostgreSQL Virtual Network Rule.
    returned: always
    type: complex
    contains:
        postgresqlvirtualnetworkrule_name:
            ...
            contains:
                id:
                    ...
                    returned: always
                    type: str
                    sample: "/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforPostgreSQL/servers/vnet-te
                            st-svr/virtualNetworkRules/vnet-firewall-rule"
                name:
                    description:
                        - Resource name.
                    returned: always
