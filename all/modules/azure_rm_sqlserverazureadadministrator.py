...
id:
    ...
    returned: always
    type: str
    sample: /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-4799/providers/Microsoft.Sql/servers/sqlcrudtest-6440/administrators/activeDirectory
'''
...
class AzureRMServerAzureADAdministrators(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            ...
            while self.get_serverazureadadministrators():
                time.sleep(20)
        else:
